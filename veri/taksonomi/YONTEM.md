...
`sdp_kodlari.csv` — 118 satır, UTF-8 (BOM'suz), LF satır sonu, virgül ayraç,
...
`vatandas_konusu=evet`: 53 satır (%45). Seviye dağılımı: 57 / 49 / 12.
...
Dört dosyadaki **1966 resmî kayıttan** (718 ortak + 392 belediye + 468 üniversite + 388 MEB) 118'i seçildi. Ölçüt: **gerçek evrak trafiğinin büyük kısmını
...
**Son çalıştırma: 118/118 satır, 0 hata.**
...
**`ornek_konular` doğrulanamaz.** Kodlar ve adlar resmî kaynaktan gelir; konu başlıkları
kurumsal yazışma pratiğinden yazılmıştır. Hata payı buradadır.

**Kapsam kısıtı.** 1966 resmî kayıttan 118'i seçildi. Nadir ama meşru kodlar dışarıda
